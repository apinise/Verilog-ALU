...
set_property PACKAGE_PIN V2 [get_ports {F[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {F[0]}]
set_property PACKAGE_PIN T3 [get_ports {F[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {F[1]}]
set_property PACKAGE_PIN T2 [get_ports {F[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {F[2]}]
set_property PACKAGE_PIN R3 [get_ports {F[3]}]					
